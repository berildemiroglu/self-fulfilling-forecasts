...
def run_pilot(epsilon, n_rounds, seed):
    ...
    # --- H1a mechanical baseline decomposition (pilot version) ---
    # Use round-1 agent bias (forecast vs F_t) as a simple proxy for
    # "how biased were the agents before epsilon had a chance to compound it"
    import numpy as np
...
if __name__ == "__main__":
    run_pilot(epsilon=0.4, n_rounds=40, seed=1)